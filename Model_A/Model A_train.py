# This is the code of training for binary classifier.
# With dataset of cats-vs-dogs
# similar steps like assignment 1 for model A.
...
# Model training: Data augmentation and normalization
...
# Loading the dogs-vs-cats images
...
if __name__ == "__main__":
    ...
    cat_dog_dataset = AnimalImage(data_root="./dogs_vs_cats_dataset/train/train", transformation=get_transformation())
